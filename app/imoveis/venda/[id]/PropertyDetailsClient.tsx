...
export default function PropertyDetailsClient({ property }: { property: Property }) {
  ...
  const detalhes = [
    { label: "Condomínio", value: "R$ 1.200/mês" },
    { label: "IPTU", value: "R$ 350/mês" },
    { label: "Vaga de Garagem", value: "1 vaga coberta" },
    { label: "Andar", value: "7º andar" },
    { label: "Posição", value: "Frente, sol da manhã" },
    ...
    { label: "Elevador", value: <CheckCircle className="inline h-5 w-5 text-green-600" aria-label="Elevador" /> },
  ...
  return (
    <article className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg p-6 md:p-10 mt-8 mb-12">
      <div className="mb-6">
        <Link href="/imoveis/venda" className="inline-flex items-center gap-2 text-blue-900 hover:underline font-medium focus:outline-none focus:ring-2 focus:ring-blue-400 rounded px-2 py-1" aria-label="Voltar para a listagem de imóveis à venda">
          <ArrowLeft className="h-5 w-5" />
          Voltar para imóveis à venda
        </Link>
      </div>
      <header className="mb-6">
        ...
        <div className="text-2xl font-bold text-blue-900 mb-2">{formattedPrice}</div>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-800 leading-relaxed">
          Excelente oportunidade em Copacabana! Apartamento espaçoso, bem iluminado, com vista livre, próximo ao metrô, praia, comércio e escolas. Ideal para famílias que buscam conforto e praticidade em um dos bairros mais valorizados do Rio de Janeiro. Condomínio com portaria 24h, elevador, vaga de garagem e área de lazer.
        </p>
      </section>
      <section className="mb-8">
      ...
      <section className="mb-8">
        ...
        <div className="rounded-lg overflow-hidden border w-full h-72 flex flex-col items-center justify-center">
          ...
          <button
            ...
            onClick={() => window.open('https://www.openstreetmap.org/?mlat=-22.971964&mlon=-43.182545#map=15/-22.971964/-43.182545', '_blank')}
            type="button"
